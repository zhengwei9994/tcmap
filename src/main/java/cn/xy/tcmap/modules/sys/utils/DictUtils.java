...
import cn.xy.tcmap.modules.sys.dao.DictDao;
...
public class DictUtils {
	...
	private static CatchIndexNameDao catchIndexNameDao = SpringContextHolder.getBean(CatchIndexNameDao.class);
	 ...
	 * @author gxq
	 */
	public static List<CatchIndexName> getEcomicList(){
		List<CatchIndexName> list = catchIndexNameDao.findAllList(new CatchIndexName());
		if (list == null){
