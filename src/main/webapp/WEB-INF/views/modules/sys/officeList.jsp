...
<body>
	...
	<ul class="nav nav-tabs">
		...
		<shiro:hasPermission name="sys:office:edit"><li><a href="${ctx}/sys/office/form?parent.id=${office.id}">组织添加</a></li></shiro:hasPermission>
		<li id="btnImport"><a href="#">导入</a></li>
		<li id="btnExport"><a href="#">导出</a></li>
	</ul>
	<div  style="display:none;">
		<form:form id="exportForm" modelAttribute="office" action="${ctx}/sys/office/export" method="post" class="breadcrumb form-search"/>
	</div>
