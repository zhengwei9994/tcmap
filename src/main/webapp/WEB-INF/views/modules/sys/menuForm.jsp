...
<body>
	...
	<form:form id="inputForm" modelAttribute="menu" action="${ctx}/sys/menu/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="49" class="required input-xlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="sort" htmlEscape="false" maxlength="5" class="required digits input-small"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="permission" htmlEscape="false" maxlength="99" class="input-xxlarge"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="3" maxlength="199" class="input-xxlarge"/>
			</div>
		</div>
